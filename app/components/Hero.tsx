...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex flex-col md:flex-row items-center justify-center p-6 md:p-24 relative overflow-hidden">
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[600px] h-[600px] bg-violet-600/10 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <div className="relative z-10 w-full max-w-[1200px] flex flex-col md:flex-row items-center gap-16 md:gap-24">
        <div className="flex-1 text-center md:text-left space-y-8 order-2 md:order-1">
          ...
          <div className="flex items-center justify-center md:justify-start gap-5 pt-6">
            <button
              ...
              className="px-10 py-4 bg-white text-black text-xs font-black uppercase tracking-widest rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-white/5"
            >
              View Portfolio
            </button>
            <button
              onClick={() => scrollToSection("contact")}
              className="px-10 py-4 bg-zinc-900 border border-zinc-800 text-white text-xs font-black uppercase tracking-widest rounded-2xl hover:bg-zinc-800 transition-all"
            >
              Contact Me
            </button>
          </div>
        ...
        <div className="relative w-72 h-72 md:w-[450px] md:h-[450px] flex-shrink-0 order-1 md:order-2 group">
          <motion.div
            ...
            className="absolute -inset-4 bg-violet-600/30 rounded-full blur-3xl opacity-50 group-hover:opacity-80 transition-opacity duration-1000"
          />
